...
/**
   ...
   */
   public class Connection
   {
      ...
      */
      public void dial(String key) // modified function 
      {
   	   ...
   	   if (state == CONNECTED) {
        	...
        	if (key.equals("1")) {
 			   ...
 			   System.out.println("Record message. Enter H when finished.");
 		   }
 		   else if (key.equals("2")) {
 			   System.out.println("Mailbox Access. Enter password followed by a #.");
 			   String pass = in.next();
 			   login(pass);
 		   }
 		   else if (key.equals("#")) { 
      ...
      */
      public void hangup()
      {
         ...
         System.out.println("You recorded: " + currentRecording);
         resetConnection();
      }
      ...
      */
      private void connect(String key)
      {
         if (key.equals("#"))
         {
            ...
            {//modified method in order to acomodate more decisions
               state = RECORDING;
               phone.speak(DECISION);
            }
            else {
               phone.speak("Incorrect mailbox number. Try again!" );
            dial("2");//added for more decisions
         }
         accumulatedKeys = "";
      }
         else
   ...
   private Mailbox currentMailbox;
     ...
     //decision string added 
     private static final String DECISION = "Enter 1 to leave a message, Enter 2 to access your mailbox";
